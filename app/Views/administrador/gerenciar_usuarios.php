        ...
        <div class="card mb-4">
            ...
            <div class="card-body px-0 pt-0 pb-2">
                <div class="table-responsive p-0">
                    <?php echo form_open('administrador/editarUsuario',array('name'=>'form_usuarios', 'id'=>'form_usuarios'));?>
...
<script>
    function novoUsuario(){
        document.location.href = "administrador/novoUsuario";
    }
</script>

<script defer>
    $.ajax({
        url : "<?php echo base_url('administrador/retornaUsuarios')?>",
        type : 'POST',
        dataType: "json",
