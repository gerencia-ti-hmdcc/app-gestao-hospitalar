...
<div class="row">
    <div class="col-lg-12 mb-<?php echo $variavel_controle_margem_tv; ?>">
        <div class="card premium-dashboard-card card-blue-strip z-index-2">
            <div class="card-header pb-0">
                <div class="row">
                    <div class="col-lg-6 col-7">
                        <h6>Gráfico Geral de Ocupação - <span style='font-size: 12px' id='data_ult_att'
                                name='data_ult_att'></span></h6>
                    </div>
                    <div class="col-lg-6 col-5 my-auto text-end">
                        <div class="dropdown float-lg-end pe-4">
                            <a class="cursor-pointer" onclick="abrirModalInformacoes('modal_grafico_geral')"
                                aria-expanded="false"> <!-- id="dropdownTable" data-bs-toggle="dropdown" -->
...
<div class="row my-4">
    <div class="col-lg-12 col-md-12 mb-<?php echo $variavel_controle_margem_tv; ?>" id="divGeral" name="divGeral">
        <!--mb-md-0-->
        <div class="card premium-dashboard-card card-green-strip" id="tabela_detalhes" name="tabela_detalhes">
            <div class="card-header pb-0">
                <div class="row">
                    <div class="col-lg-6 col-7">
                    ...
                    <div class="col-lg-6 col-5 my-auto text-end">
                        <div class="dropdown float-lg-end pe-4">
                            <a class="cursor-pointer" onclick="abrirModalInformacoes('modal_tabela_setor')"
                                aria-expanded="false"> <!-- id="dropdownTable" data-bs-toggle="dropdown" -->
                                <i class="fa fa-question-circle text-secondary"></i>
                            </a>
                        </div>
            ...
            <div class="card-body px-0 pb-2">
                        ...
                        <thead>
                            <tr>
                                <th style="background-color: white"
                                    ...
                                    Setor</th>
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Linha
                                    Cuidado</th>
                                <th
                ...
                <input type='hidden' value='<?php echo $usuario_logado["painel_variavel_controle"]; ?>'
                    id='painel_variavel_controle' name='painel_variavel_controle' />
            </div>
        </div>
    </div>
