        ...
        <div class="card mb-4">
            ...
            <div class="card-body px-0 pt-0 pb-2">
                <div class="table-responsive p-0">
                    <table class="table align-items-center justify-content-center mb-0">
                        <thead>
                            ...
                            <tr>
                                ...
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder">
                                    <?php echo $dados_usuario["NOME_TIPO_PERFIL"]; ?>
                                </th>
                            </tr>
                            <tr>
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Último
                                    Login</th>
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder">
                                    <?php echo $dados_usuario["ULTIMO_LOGIN"]; ?>
                                </th>
                            </tr>
                            <tr>
                                <th colspan="2"
                                    class="text-uppercase text-secondary text-xxs font-weight-bolder text-center">
                                    Período de pesquisas de logs</th>
                            </tr>
                            <tr>
                                <th colspan="2" class="p-0 border-0">
                                    <label class="d-block cursor-pointer px-3 py-2 mb-0"
                                        onclick="document.getElementById('data1_log').showPicker()">
                                        <span
                                            class="text-uppercase text-secondary text-xxs font-weight-bolder d-block mb-1">Mês
                                            Inicial</span>
                                        <input required='true' class="form-control" type="month" id="data1_log"
                                            name='data1_log' style="max-width: 100%;" />
                                        <span
                                            class="text-xxs font-weight-normal mt-1 d-block text-lowercase text-muted">*Se
                                            vazio, o valor assumido será 05/2024.</span>
                                    </label>
                                </th>
                            </tr>
                            <tr>
                                <th colspan="2" class="p-0 border-0">
                                    <label class="d-block cursor-pointer px-3 py-2 mb-0"
                                        onclick="document.getElementById('data2_log').showPicker()">
                                        <span
                                            class="text-uppercase text-secondary text-xxs font-weight-bolder d-block mb-1">Mês
                                            Final</span>
                                        <input required='true' class="form-control" type="month" id='data2_log'
                                            name='data2_log' style="max-width: 100%;" />
                                        <span
                                            class="text-xxs font-weight-normal mt-1 d-block text-lowercase text-muted">*Se
                                            vazio, o valor assumido será o mês atual.</span>
                                    </label>
                                </th>
                            </tr>
                            <tr>
                                <th colspan="2"
                                    ...
                                    <button class="mb-0 btn btn-primary" onclick="pesquisaLogsUsuarioPeriodo();">
                                        Pesquisar</button>
                                </th>
                            </tr>
                        </thead>
                    ...
                    <input name="id_usuario_log" id="id_usuario_log" type="hidden"
                        value='<?php echo $dados_usuario["ID"]; ?>' />
                </div>
            </div>
        </div>
    </div>
