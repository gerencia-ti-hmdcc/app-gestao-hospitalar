...
class Admissoes extends MY_Controller {
    ...
    // public function admissoes_periodicas(){

    //     $usuario  = $_SESSION["usuario_logado"];
        

    //     $this->load->helper('form');
    //     $dados['nome_pagina']       = 'Admissões periódicas';
    //     $dados['pagina']            = 'admissoes/admissoes_periodicas.php';
    //     $dados["link_pagina"]       = 'admissoes/admissoes_periodicas';
    //     $dados["tipo_perfil"]       = $usuario["TIPO_PERFIL"];
    //     $dados["diretorio_raiz"]    = '../';
