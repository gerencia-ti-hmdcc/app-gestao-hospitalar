...
class Admissoes extends MY_Controller {
    ...
    public function __construct(){
        ...
        if(!$usuario){
            ...
            // }
            $funcao_permitida = $this->my_model->retornaSeFuncaoPermitida($usuario["ID"],'admissoes');
	...
	public function index()
	{
        ...
        $meta_admissoes_internas_cti                = count($this->admissoes_model->retornaMetasAnuaisPorLinha($dados["ano_calendario"],$dados["quadrimestre"],1,'I'))  == 0 ? 1 : $this->admissoes_model->retornaMetasAnuaisPorLinha($dados["ano_calendario"],$dados["quadrimestre"],1,'I')[0]["QUANTIDADE"];
        $meta_admissoes_externas_cti                = count($this->admissoes_model->retornaMetasAnuaisPorLinha($dados["ano_calendario"],$dados["quadrimestre"],1,'E'))  == 0 ? 1 : $this->admissoes_model->retornaMetasAnuaisPorLinha($dados["ano_calendario"],$dados["quadrimestre"],1,'E')[0]["QUANTIDADE"];
        $meta_admissoes_externas_clinica_medica     = count($this->admissoes_model->retornaMetasAnuaisPorLinha($dados["ano_calendario"],$dados["quadrimestre"],10,'E')) == 0 ? 1 : $this->admissoes_model->retornaMetasAnuaisPorLinha($dados["ano_calendario"],$dados["quadrimestre"],10,'E')[0]["QUANTIDADE"];
        $meta_admissoes_externas_avc                = count($this->admissoes_model->retornaMetasAnuaisPorLinha($dados["ano_calendario"],$dados["quadrimestre"],9,'E'))  == 0 ? 1 : $this->admissoes_model->retornaMetasAnuaisPorLinha($dados["ano_calendario"],$dados["quadrimestre"],9,'E')[0]["QUANTIDADE"];
        $meta_admissoes_externas_clinica_cirurgica  = count($this->admissoes_model->retornaMetasAnuaisPorLinha($dados["ano_calendario"],$dados["quadrimestre"],11,'E')) == 0 ? 1 : $this->admissoes_model->retornaMetasAnuaisPorLinha($dados["ano_calendario"],$dados["quadrimestre"],11,'E')[0]["QUANTIDADE"];
        $meta_admissoes_hd                          = count($this->admissoes_model->retornaMetasAnuaisPorLinha($dados["ano_calendario"],$dados["quadrimestre"],13,'E')) == 0 ? 1 : $this->admissoes_model->retornaMetasAnuaisPorLinha($dados["ano_calendario"],$dados["quadrimestre"],13,'E')[0]["QUANTIDADE"];
    ...
    public function admissoes_por_linha(){
        ...
        if($dados["nr_agrupamento"]==1){
            $dados["meta_interna"] = count($this->admissoes_model->retornaMetasAnuaisPorLinha($dados["ano_calendario"],$dados["quadrimestre"],1,'I'))  == 0 ? 1 : $this->admissoes_model->retornaMetasAnuaisPorLinha($dados["ano_calendario"],$dados["quadrimestre"],1,'I')[0]["QUANTIDADE"];
            $dados["meta_externa"] = count($this->admissoes_model->retornaMetasAnuaisPorLinha($dados["ano_calendario"],$dados["quadrimestre"],1,'E'))  == 0 ? 1 : $this->admissoes_model->retornaMetasAnuaisPorLinha($dados["ano_calendario"],$dados["quadrimestre"],1,'E')[0]["QUANTIDADE"];
            ...
            $dados["meta_externa"] = count($this->admissoes_model->retornaMetasAnuaisPorLinha($dados["ano_calendario"],$dados["quadrimestre"],9,'E'))  == 0 ? 1 : $this->admissoes_model->retornaMetasAnuaisPorLinha($dados["ano_calendario"],$dados["quadrimestre"],9,'E')[0]["QUANTIDADE"];
            ...
            $dados["meta_externa"] = count($this->admissoes_model->retornaMetasAnuaisPorLinha($dados["ano_calendario"],$dados["quadrimestre"],10,'E')) == 0 ? 1 : $this->admissoes_model->retornaMetasAnuaisPorLinha($dados["ano_calendario"],$dados["quadrimestre"],10,'E')[0]["QUANTIDADE"];
            ...
            $dados["meta_externa"] = count($this->admissoes_model->retornaMetasAnuaisPorLinha($dados["ano_calendario"],$dados["quadrimestre"],11,'E')) == 0 ? 1 : $this->admissoes_model->retornaMetasAnuaisPorLinha($dados["ano_calendario"],$dados["quadrimestre"],11,'E')[0]["QUANTIDADE"];
            ...
            $dados["meta_externa"] = count($this->admissoes_model->retornaMetasAnuaisPorLinha($dados["ano_calendario"],$dados["quadrimestre"],13,'E')) == 0 ? 1 : $this->admissoes_model->retornaMetasAnuaisPorLinha($dados["ano_calendario"],$dados["quadrimestre"],13,'E')[0]["QUANTIDADE"];
    ...
    public function retornaDetalhesAdmissoesMesPeriodicas(){
        ...
        if(strlen($dia)>0 && strlen($mes)>0 && strlen($ano)>0){
            $this->load->model('admissoes_model');
            print json_encode($this->admissoes_model->retornaDetalhesAdmissoesMesPeriodicas($dia,$mes,$ano));
        }else{
            $this->session->set_flashdata("danger","Houve um erro ao gerar os detalhes das admissões. Atualize a página!");
            return;
        }
    ...
    public function retornaDetalhesOfertasDiariasPeriodicas(){
        ...
        if(strlen($dia)>0 && strlen($mes)>0 && strlen($ano)>0){
            $this->load->model('admissoes_model');
            print json_encode($this->admissoes_model->retornaDetalhesOfertasDiariasPeriodicas($ano,$mes,$dia));
        }else{
            $this->session->set_flashdata("danger","Houve um erro ao gerar os detalhes das admissões. Atualize a página!");
            return;
        }
