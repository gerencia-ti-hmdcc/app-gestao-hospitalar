                    ...
                    <table class="table align-items-center justify-content-center mb-0">
                        <thead>
                            ...
                            <tr>
                                ...
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder"><?php echo $dados_usuario["NOME_TIPO_PERFIL"];?></th>
                            </tr>
                            <tr>
...
<script>
    function pesquisaLogsUsuarioPeriodo(){
        ...
        $.ajax({
            url : "<?php echo site_url('retornaLogUsuarioPeriodo');?>",
            type : 'POST',
            dataType: "json",
            data: 
            {
