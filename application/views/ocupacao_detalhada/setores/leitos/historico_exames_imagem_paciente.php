...
function retornaTokenPacs($nr_acesso_dicom){
    ...
    # ALGAR
    $algar_encrypt_base_url     = "https://187.72.169.37/portal/CSPublicQueryService/CSPublicQueryService.svc/json/Encrypt";
    # PRODABEL
    $prodabel_encrypt_base_url  = "https://187.72.169.37/portal/CSPublicQueryService/CSPublicQueryService.svc/json/Encrypt";
